  ...
  return (
    <div className="flex flex-wrap items-start justify-between gap-4">
      <div className="min-w-0 flex-1">
        <h3 className="text-sm font-semibold text-text-primary">Temu scraper</h3>
        <p className="mt-1 text-sm text-text-secondary">
          Kill switch for Temu URL import and the stock-sync cron. When stopped,
          imports return an error and sync jobs skip.
        </p>
        {isLoading ? (
      ...
      {canWrite ? (
        <Button
          ...
          aria-label={enabled ? 'Stop Temu scraper' : 'Start Temu scraper'}

...
function defaultSiteBranding(): SiteBrandingDTO {
  return {
    ...
    logoUrl: '/images/brand/sqoosh-icon.svg',
    faviconUrl: '/images/brand/sqoosh-icon.svg',
    contactEmail: null,
    contactPhone: null,
    whatsappNumber: null,
  ...
  async (): Promise<SiteBrandingDTO> => {
    try {
      ...
      return {
        ...
        logoUrl: asString(map.logo_url) ?? '/images/brand/sqoosh-icon.svg',
        faviconUrl: asString(map.favicon_url) ?? '/images/brand/sqoosh-icon.svg',

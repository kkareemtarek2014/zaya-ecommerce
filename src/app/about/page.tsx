...
export const metadata: Metadata = {
  title: `About Zeena | Premium Women's Accessories in Egypt`,
  description:
    'Discover the story behind Zeena. We bring you curated collections of elegant jewelry, bags, scarves, and accessories across Egypt with cash on delivery.',
    ...
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center animate-fade-up">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-text-secondary leading-relaxed">
          Zeena was born from a simple belief: every woman deserves to feel confident, elegant, and perfectly styled. We meticulously curate premium accessories to elevate your everyday look.
        </p>
      </div>
      ...
      <div className="mt-16 grid gap-12 lg:grid-cols-2 lg:gap-8 items-center animate-fade-up" style={{ animationDelay: '100ms' }}>
        <div className="relative aspect-square overflow-hidden rounded-(--radius-lg) bg-brand-blush">
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center text-brand-primary/40">
            ...
            <span className="mt-4 font-(family-name:--font-display) text-2xl font-bold tracking-widest text-brand-primary/40">ZEENA</span>
          </div>
        </div>
